          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((proj) => (
              <Link
                ...
                className="group rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-all hover:shadow-lg hover:border-myorange-100/30"
              >
                <h2 className="text-xl font-semibold text-gray-900 group-hover:text-myorange-100 transition-colors">
                  {proj.title}
                </h2>
                {proj.description && (
