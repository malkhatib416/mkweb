					...
					>
						...
						<div className="flex flex-wrap items-center gap-3 mb-6">
							<div className="flex items-center gap-2 bg-myorange-100/10 text-myorange-100 px-4 py-2 rounded-full">
								...
								<span className="font-medium">{dict.about.location} {dict.about.chartres}</span>
							</div>
						...
						<div className="mb-6 p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl border border-green-100">
							<p className="text-gray-700 text-sm font-medium">
								<span className="text-green-600">🌍</span> {dict.about.remoteDescription}
							</p>
						</div>
						...
						<div className="bg-white rounded-2xl p-6 shadow-lg mb-6 border border-gray-100">
							<div className="flex items-start gap-3 mb-4">
								...
								<p className="text-gray-700 leading-relaxed">
									{dict.about.services}{" "}
									<span className="font-bold text-myorange-100">{dict.about.creation}</span>
									, l'<span className="font-bold text-myorange-100">{dict.about.optimization}</span>
									{" "}{dict.about.to} la{" "}
									<span className="font-bold text-myorange-100">{dict.about.maintenance}</span>
						...
						<div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
							<div className="flex items-start gap-3">
								...
								<p className="text-gray-700 leading-relaxed">
									...
									<span className="font-bold text-myorange-100">{dict.about.innovative}</span>
									{" "}{dict.about.to}{" "}
									<span className="font-bold text-myorange-100">{dict.about.fluidUX}</span>
