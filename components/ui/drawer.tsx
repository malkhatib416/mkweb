...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        'fixed inset-x-0 bottom-0 z-50 mt-24 flex max-h-[92vh] flex-col rounded-t-[2rem] border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950',
        className,
      )}
      {...props}
    >
      <div className="mx-auto mt-4 h-1.5 w-14 rounded-full bg-slate-200 dark:bg-slate-700" />
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
));
