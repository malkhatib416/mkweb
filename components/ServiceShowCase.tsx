...
export default function ServiceShowCase({ dict }: Props) {
	const services = [
		...
		},
		{
			...
			title: dict.services.hosting.title,
			description: dict.services.hosting.description,
			features: [
				dict.services.hosting.feature1,
				dict.services.hosting.feature2,
				dict.services.hosting.feature3,
			],
		},
		{
